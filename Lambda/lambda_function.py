...
def recommend_portfolio(intent_request):
    ...
    if risk_level == "high":
        return close(
            ...
            "content": f"Thank you for your information; The recommended portfolio for a {risk_level} level of risk is 20% bonds (AGG), 80% equities (SPY)."
            }
        )
        ...
        return close(
            ...
            {
            "contentType": "PlainText",
            "content": f"Thank you for your information; The recommended portfolio for a {risk_level} level of risk is 40% bonds (AGG), 60% equities (SPY)."
            }
        )
        ...
        return close(
            ...
            {
            "contentType": "PlainText",
            "content": f"Thank you for your information; The recommended portfolio for a {risk_level} level of risk is 60% bonds (AGG), 40% equities (SPY)."
            }
        )
        ...
        return close(
            ...
            {
            "contentType": "PlainText",
            "content": f"Thank you for your information; The recommended portfolio for a {risk_level} level of risk is 100% bonds (AGG), 0% equities (SPY)."
            }
        )
